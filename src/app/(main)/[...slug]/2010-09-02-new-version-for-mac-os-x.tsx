...
export const content = (
  <>
    <Typo variant="paragraph">
      In this release of <strong>{APP_NAME} for Mac</strong> software we've changed a layout of user controls, so the
      Windows and Mac editions have the same look. People who use our program on both platforms should be happy :)
    </Typo>
    <Typo variant="paragraph">
